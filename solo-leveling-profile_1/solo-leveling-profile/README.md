...
<a href="#-cleared-dungeons-featured-projects">
  <img src="assets/greeting.svg" alt="Do you really want to become a Player?" width="560" />
</a>

<sub>(Every visitor sees this same prompt — GitHub gives no way to detect who's
logged in on a README, so this is a static greeting rather than a real
per-visitor check. Both buttons scroll to the projects section below.)</sub>

# 🗡️ DEVELOPER STATUS WINDOW

<img src="assets/status-card.svg" alt="Status card" width="560" />

<table>
<tr>
<td><img src="assets/quest-card.svg" alt="Daily quest" width="420" /></td>
<td><img src="assets/notification.svg" alt="Latest notification" width="420" /></td>
</tr>
</table>
